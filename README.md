...
[![Build Status](https://travis-ci.org/Haehnchen/crypto-trading-bot-binance-margin.svg?branch=master)](https://travis-ci.org/Haehnchen/crypto-trading-bot-binance-margin)
...
You'll also need to create a Telegram group, the place where you and crypto-trading-bot-binance-margin will communicate. After creating it, add the bot as administrator (make sure to uncheck "All Members Are Admins").
