...
[![Build Status](https://travis-ci.org/Haehnchen/crypto-trading-bot-binance-futuros.svg?branch=master)](https://travis-ci.org/Haehnchen/crypto-trading-bot-binance-futuros)
...
➜ docker-compose up -d
```
After this you can use `docker-compose` which will give you a running bot via <http://127.0.0.1:8081>
...
You'll also need to create a Telegram group, the place where you and crypto-trading-bot-binance-futuros will communicate. After creating it, add the bot as administrator (make sure to uncheck "All Members Are Admins").
 ...
 * Signals: http://127.0.0.1:8081/signals
 * Tradingview: http://127.0.0.1:8081/tradingview/BTCUSD
 * Backtesting: http://127.0.0.1:8081/backtest
 * Order & Pair Management: http://127.0.0.1:8081/pairs
