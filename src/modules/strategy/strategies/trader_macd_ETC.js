...
module.exports = class TraderCustom {
  ...
  buildIndicator(indicatorBuilder, options) {
    ...
    indicatorBuilder.add('ema1006H', 'hma', '6h', {
      length: 9,
    });
  ...
  async trader_custom(
    ...
    const ema1006H = ema1006HFull.slice(-1)[0];
    ...
    */
    ...
    //obv 6H, 4H, 1D
    //01 16 -1.248
    let resolve_obv = this.resolve_obv(debug, obv1D, count_ovb1D, 1.058, 2);
    ...
    resolve_obv = this.resolve_obv(debug, obv6H, count_ovb6H, 1.683, 4);
    count_signals_buy += resolve_obv.buy;
    count_signals_sell += resolve_obv.sell;
    ...
    resolve_obv = this.resolve_obv(debug, obv4H, count_ovb4H, 0.9408, 3.5);
    count_signals_buy += resolve_obv.buy;
    count_signals_sell += resolve_obv.sell;
